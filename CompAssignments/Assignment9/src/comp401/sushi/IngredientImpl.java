...
/**
 * A general implementation for the {@link Ingredient} interface.
 * It contains common implementation for the subclasses from {@code Avocado}
 * to {@code Shrimp}.
 * @author KMP
 */
public class IngredientImpl implements Ingredient {
	...
	/**
	 * A helper constructor for the subclass.
	 * @throws RuntimeException when {@code amount <= 0}.
	 */
